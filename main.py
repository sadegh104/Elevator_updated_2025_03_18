...
if st.button('ثبت'):
        ...
        if new_valueb20 == new_valuec20:
            if new_valueb3 == new_valuec3 or new_valueb3 == new_valued3 or new_valueb3 == new_valuee3:
                ...
                SimBoxelScore10Description = f"""
                            <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['I2'].value}</td>
                            <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{(int(new_valueb2)) * int(round(((new_valueb8 + 9) - 2) * new_valueb17))} (متر)</td>
            ...
            if new_valueb3 == new_valuec3 or new_valueb3 == new_valued3 or new_valueb3 == new_valuee3:
                ...
                SimBoxelScore10Description = f"""
                            <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['I2'].value}</td>
                            <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{(int(new_valueb2)) * int(round((((new_valueb8 + new_valueb9 + new_valueb10) * 2) + 8 + new_valueb21) * new_valueb17))} (متر)</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['I2'].value:,.0f}</td></tr></table>
                            """
                st.markdown(SimBoxelScore10Description, unsafe_allow_html=True)
            elif new_valueb3 == new_valuef3 or new_valueb3 == new_valueg3:
    ...
    SimBoxelScore6Description = f"""
                                <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['I4'].value}</td>
                                <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{(int(new_valueb2)) * int(math.ceil((new_valueb10 + new_valueb9 + new_valueb8 + 2))) * 2} (متر)</td>
    ...
    if new_valueb14 == new_valuec14 and new_valueb3 == new_valuec3:
        ...
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuec3) - 75)/45)}</td>
        ...
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valued3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuee3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuee3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuef3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuef3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valueg3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valueg3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valueh3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valueh3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuei3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuei3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuej3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuej3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuek3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuek3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuel3:
        WazneDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS8'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuel3) - 75)/45)}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS8'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valued14 and new_valueb3 == new_valuec3:

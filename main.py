        ...
        if sheet_name == 'Data (1)':
            ...
            if cellb20.value == cellc20.value:
                new_valueb21 = st.number_input('فاصله فلکه های کابین (متر)',
                                           key=f'{cellb21.coordinate}_{sheet_name}', value=1.5)
...
if st.button('ثبت'):
        ...
        if new_valueb19 == new_valuec19:    
            if new_valueb20 == new_valuec20:
                if new_valueb3 == new_valuec3 or new_valueb3 == new_valued3 or new_valueb3 == new_valuee3:
                    ...
                    SimBoxelScore10Quantity = f"""
                                <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{(int(new_valueb2)) * int(round(((new_valueb8 + 9) - 2) * new_valueb17))} m</div>
                                """
                    st.markdown(SimBoxelScore10Quantity, unsafe_allow_html=True)
                ...
                if new_valueb3 == new_valuec3 or new_valueb3 == new_valued3 or new_valueb3 == new_valuee3:
                    ...
                    # st.markdown(SimBoxelScore10Quantity, unsafe_allow_html=True)
                    SimBoxelScore10Quantity = f"""
                                <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{(int(new_valueb2)) * int(round((((new_valueb8 + new_valueb9 + new_valueb10) * 2) + 8 + new_valueb21) * new_valueb17))} m</div>
                                """
                    st.markdown(SimBoxelScore10Quantity, unsafe_allow_html=True)
                elif new_valueb3 == new_valuef3 or new_valueb3 == new_valueg3:
                    SimBoxelScore10Quantity = f"""
            ...
            if new_valueb20 == new_valuec20:
                if new_valueb3 == new_valuec3 or new_valueb3 == new_valued3 or new_valueb3 == new_valuee3:
                    ...
                    # """
                    # st.markdown(SimBoxelScore10Quantity, unsafe_allow_html=True)
                    SimBoxelScore8Quantity = f"""
                                <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{(int(new_valueb2)) * int(round(((new_valueb8 + 9) - 2) * new_valueb17))} m</div>
                                """
                    st.markdown(SimBoxelScore8Quantity, unsafe_allow_html=True)
                elif new_valueb3 == new_valuef3 or new_valueb3 == new_valueg3:
                    SimBoxelScore8Quantity = f"""
                                            <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{(int(new_valueb2)) * int(round(((new_valueb8 + 9) - 2) * new_valueb17))} m</div>
                                            """
    ...
    with cols[1]:
        SimBoxelScore6Quantity = f"""
                            <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{(int(new_valueb2)) * int(math.ceil((new_valueb10 + new_valueb9 + new_valueb8 + 2))) * 2} m</div>
                            """
    ...
    with cols[1]:
        ...
        if new_valueb19 == new_valuec19:
            if new_valueb3 == new_valuef3 or new_valueb3 == new_valueg3:
                ...
                """
                st.markdown(GholabBoxelScore10Quantity, unsafe_allow_html=True)
        if new_valueb19 == new_valued19:
            if new_valueb3 == new_valuec3 or new_valueb3 == new_valued3 or new_valueb3 == new_valuee3:
                GholabBoxelScore8Quantity = f"""
                <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{(int(new_valueb2)) * int((new_valueb17) * 2)}</div>
                """
                st.markdown(GholabBoxelScore8Quantity, unsafe_allow_html=True)
        if new_valueb19 == new_valued19:
            if new_valueb3 == new_valuef3 or new_valueb3 == new_valueg3:
                GholabBoxelScore8Quantity = f"""
                <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{(int(new_valueb2)) * int((new_valueb17) * 2)}</div>
    ...
    with cols[0]:
        if ws1['B5'].value == ws1['C5'].value and ws1['B19'].value == ws1['C19'].value: 
            ...
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                FalakeHarzgardDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['K6'].value}</div>
                """
                st.markdown(FalakeHarzgardDescription, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value:
                FalakeHarzgardDescription = f"""
            ...
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                FalakeHarzgardDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['K10'].value}</div>
                """
                st.markdown(FalakeHarzgardDescription, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value:
                FalakeHarzgardDescription = f"""
            ...
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                FalakeHarzgardDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['K14'].value}</div>
                """
                st.markdown(FalakeHarzgardDescription, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value:
                FalakeHarzgardDescription = f"""
    ...
    with cols[1]:
        ...
        """
        st.markdown(FalakeHarzgardQuantity, unsafe_allow_html=True)
    cols = st.columns(2)
    with cols[0]:
        if ws1['B5'].value == ws1['C5'].value and ws1['B19'].value == ws1['C19'].value: 
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                BoxelDiameterDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ1'].value}</div>
                """
    ...
    with cols[1]:
        if ws1['B5'].value == ws1['C5'].value and ws1['B19'].value == ws1['C19'].value: 
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ2'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ3'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['H3'].value or ws1['B3'].value == ws1['I3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ4'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['J3'].value or ws1['B3'].value == ws1['K3'].value or ws1['B3'].value == ws1['L3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ5'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
        elif ws1['B5'].value == ws1['D5'].value and ws1['B19'].value == ws1['C19'].value:
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ6'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ7'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['H3'].value or ws1['B3'].value == ws1['I3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ8'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['J3'].value or ws1['B3'].value == ws1['K3'].value or ws1['B3'].value == ws1['L3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ9'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
        elif ws1['B5'].value == ws1['C5'].value and ws1['B19'].value == ws1['D19'].value:
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ10'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ11'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['H3'].value or ws1['B3'].value == ws1['I3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ12'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['J3'].value or ws1['B3'].value == ws1['K3'].value or ws1['B3'].value == ws1['L3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ13'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
        elif ws1['B5'].value == ws1['D5'].value and ws1['B19'].value == ws1['D19'].value:
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ14'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ15'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['H3'].value or ws1['B3'].value == ws1['I3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ16'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['J3'].value or ws1['B3'].value == ws1['K3'].value or ws1['B3'].value == ws1['L3'].value:
                BoxelDiameterQuantity = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AZ17'].value}</div>
                """
                st.markdown(BoxelDiameterQuantity, unsafe_allow_html=True)
    cols = st.columns(2)
    with cols[0]:
        ...
        if ws1['B19'].value == ws1['C19'].value:
            ...
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                CorpiScore8Description = f"""
                                        <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['T6'].value}</div>
                                        """
    ...
    with cols[1]:
        if new_valueb19 == new_valuec19:    
            ...
            if new_valueb3 == new_valuec3 or new_valueb3 == new_valued3 or new_valueb3 == new_valuee3:
                # SimBoxelScore10Quant = (int(new_valueb2)) * int(round(((new_valueb8 + 9) - 2) * 4))
                CorpiScore8Quantity = f"""
                        <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{int(new_valueb2) *int((new_valueb17) * 4)}</div>
                        """
                st.markdown(CorpiScore8Quantity, unsafe_allow_html=True)
            elif new_valueb3 == new_valuef3 or new_valueb3 == new_valueg3:
                # SimBoxelScore10Quant = (int(new_valueb2)) * int(round(((new_valueb8 + 9) - 2) * 5))
                CorpiScore8Quantity = f"""
                        <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;'>{int(new_valueb2) *int((new_valueb17) * 4)}</div>
    ...
    with cols[0]:
        if ws1['B5'].value == ws1['C5'].value and ws1['B19'].value == ws1['C19'].value: 
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                ShasiDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR2'].value}</div>
                """
                ...
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR5'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
        elif ws1['B5'].value == ws1['D5'].value and ws1['B19'].value == ws1['C19'].value:
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                ShasiDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR6'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif (ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value) and (ws1['B4'].value == ws1['C4'].value):
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR7'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif (ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value) and (ws1['B4'].value == ws1['D4'].value):
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR8'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['H3'].value or ws1['B3'].value == ws1['I3'].value or ws1['B3'].value == ws1['J3'].value or ws1['B3'].value == ws1['K3'].value or ws1['B3'].value == ws1['L3'].value:
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR9'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
        elif ws1['B5'].value == ws1['C5'].value and ws1['B19'].value == ws1['D19'].value:
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                ShasiDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR10'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif (ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value) and (ws1['B4'].value == ws1['C4'].value):
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR11'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif (ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value) and (ws1['B4'].value == ws1['D4'].value):
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR12'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['H3'].value or ws1['B3'].value == ws1['I3'].value or ws1['B3'].value == ws1['J3'].value or ws1['B3'].value == ws1['K3'].value or ws1['B3'].value == ws1['L3'].value:
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR13'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
        elif ws1['B5'].value == ws1['D5'].value and ws1['B19'].value == ws1['D19'].value:
            if ws1['B3'].value == ws1['C3'].value or ws1['B3'].value == ws1['D3'].value or ws1['B3'].value == ws1['E3'].value:
                ShasiDescription = f"""
                <div  style='display:flex;flex-wrap:wrap;background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR14'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif (ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value) and (ws1['B4'].value == ws1['C4'].value):
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR15'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif (ws1['B3'].value == ws1['F3'].value or ws1['B3'].value == ws1['G3'].value) and (ws1['B4'].value == ws1['D4'].value):
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR16'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
            elif ws1['B3'].value == ws1['H3'].value or ws1['B3'].value == ws1['I3'].value or ws1['B3'].value == ws1['J3'].value or ws1['B3'].value == ws1['K3'].value or ws1['B3'].value == ws1['L3'].value:
                ShasiDescription = f"""
                <div  style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AR17'].value}</div>
                """
                st.markdown(ShasiDescription, unsafe_allow_html=True)
    with cols[1]:
        ShasiQuantity = f"""
    ...
    with cols[0]:
        if new_valueb19 == new_valuec19:    
            ...
            HefazFalakeMotorDescription = f"""
                            <div style='background-color:#f0f0f0;padding:10px;border-radius:5px;display:block;margin-bottom:5px;height:60px;text-align:center;direction:rtl;'>{ws2['AT5'].value}</div>
                            """
            st.markdown(HefazFalakeMotorDescription, unsafe_allow_html=True)
    with cols[1]:

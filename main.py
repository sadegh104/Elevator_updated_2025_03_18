    ...
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            if cellb19.value == cellc19.value:
                ...
                new_valueb20 = st.selectbox('سیستم تعلیق', options=[cellc20.value, celld20.value],
                                            key=f'{cellb20.coordinate}_{sheet_name}')
                if new_valueb20 == cellc20.value:
                    cellb20.value = cellc20.value
    ...
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            new_valueb3 = st.selectbox('ظرفیت (نفر)', options=[cellc3.value, celld3.value, celle3.value, cellf3.value,
                                                                cellg3.value, cellh3.value, celli3.value, cellj3.value,
                                                                  cellk3.value, celll3.value, cellm3.value, celln3.value],
...
with cols[2]:
    ...
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ws = wb[sheet_name]
            cellb4 = ws['B4']
            new_valueb4 = st.number_input('ضریب جبران تراول کابل',
                                          key=f'{cellb4.coordinate}_{sheet_name}', value=3.4)
cols = st.columns(3)
with cols[0]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        ...
        if sheet_name == 'Data (1)':
            ...
            new_valueb6 = st.selectbox('تعداد توقف',
                                       options=[cellc6.value, celld6.value, celle6.value, cellf6.value, cellg6.value,
                                                cellh6.value, celli6.value, cellj6.value, cellk6.value, celll6.value,
                                                cellm6.value, celln6.value, cello6.value, cellp6.value, cellq6.value, 
                                                cellr6.value, cells6.value, cellt6.value, cellu6.value, cellv6.value,
                                                cellw6.value, cellx6.value, celly6.value, cellz6.value, cellaa6.value,
                                                cellab6.value, cellac6.value, cellad6.value, cellae6.value],
            ...
            elif new_valueb6 == cellj6.value:
                cellb6.value = cellj6.value
            elif new_valueb6 == cellk6.value:
                cellb6.value = cellk6.value
            elif new_valueb6 == celll6.value:
                cellb6.value = celll6.value
            elif new_valueb6 == cellm6.value:
                cellb6.value = cellm6.value
            elif new_valueb6 == celln6.value:
                cellb6.value = celln6.value
            elif new_valueb6 == cello6.value:
                cellb6.value = cello6.value
            elif new_valueb6 == cellp6.value:
                cellb6.value = cellp6.value
            elif new_valueb6 == cellq6.value:
                cellb6.value = cellq6.value
            elif new_valueb6 == cellr6.value:
                cellb6.value = cellr6.value
            elif new_valueb6 == cells6.value:
                cellb6.value = cells6.value
            elif new_valueb6 == cellt6.value:
                cellb6.value = cellt6.value
            elif new_valueb6 == cellu6.value:
                cellb6.value = cellu6.value
            elif new_valueb6 == cellv6.value:
                cellb6.value = cellv6.value
            elif new_valueb6 == cellw6.value:
                cellb6.value = cellw6.value
            elif new_valueb6 == cellx6.value:
                cellb6.value = cellx6.value
            elif new_valueb6 == celly6.value:
                cellb6.value = celly6.value
            elif new_valueb6 == cellz6.value:
                cellb6.value = cellz6.value
            elif new_valueb6 == cellaa6.value:
                cellb6.value = cellaa6.value
            elif new_valueb6 == cellab6.value:
                cellb6.value = cellab6.value
            elif new_valueb6 == cellac6.value:
                cellb6.value = cellac6.value
            elif new_valueb6 == cellad6.value:
                cellb6.value = cellad6.value
            elif new_valueb6 == cellae6.value:
                cellb6.value = cellae6.value
...
with cols[2]:
    ...
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            cellf14 = ws['F14']
            cellg14 = ws['G14']
            if cellb3.value == cellc3.value or cellb3.value == celld3.value or cellb3.value == celle3.value or cellb3.value == cellf3.value or cellb3.value == cellg3.value:
                new_valueb14 = st.selectbox('عرض وزنه تعادل',
                                            options=[cellc14.value, celld14.value, celle14.value],
            ...
            elif cellb3.value == cellh3.value or cellb3.value == celli3.value or cellb3.value == cellj3.value or cellb3.value == cellk3.value or cellb3.value == celll3.value or cellb3.value == cellm3.value:
                new_valueb14 = st.selectbox('عرض وزنه تعادل', options=[cellc14.value, celld14.value, celle14.value, cellf14.value, cellg14.value],
                                            key=f'{cellb14.coordinate}_{sheet_name}')
                if new_valueb14 == cellc14.value:
                    cellb14.value = cellc14.value
                elif new_valueb14 == celld14.value:
                    ...
                    cellb14.value = celle14.value
                elif new_valueb14 == cellf14.value:
                    cellb14.value = cellf14.value
                elif new_valueb14 == cellg14.value:
                    cellb14.value = cellg14.value
    ...
    if cellb11.value == cellc11.value:
        new_valueb12 = st.selectbox('عرض درب',
                                    options=[cellc12.value, celld12.value, celle12.value, cellf12.value,
                                             cellg12.value, cellh12.value, celli12.value],
        ...
        elif new_valueb12 == cellg12.value:
            cellb12.value = cellg12.value
        elif new_valueb12 == cellh12.value:
            cellb12.value = cellh12.value
        elif new_valueb12 == celli12.value:
            cellb12.value = celli12.value
...
with cols[2]:
    ...
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            celle5 = ws['E5']
            cellf5 = ws['F5']
            new_valueb5 = st.selectbox('سرعت آسانسور (متر بر ثانیه)',
                                       options=[cellc5.value, celld5.value, celle5.value, cellf5.value],
            ...
            elif new_valueb5 == celle5.value:
                cellb5.value = celle5.value
            elif new_valueb5 == cellf5.value:
                cellb5.value = cellf5.value
...
with cols[0]:
    ...
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            celld31 = ws['D31']
            celle31 = ws['E31']
            new_valueb31 = st.selectbox('نوع روکش درب کابین و طبقات', options=[cellc31.value, celld31.value, celle31.value],
                                       key=f'{cellb31.coordinate}_{sheet_name}')
            if new_valueb31 == cellc31.value:
                cellb31.value = cellc31.value
            elif new_valueb31 == celld31.value:
                cellb31.value = celld31.value 
            elif new_valueb31 == celle31.value:
                cellb31.value = celle31.value
with cols[1]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            celld15 = ws['D15']
            if cellb3.value == cellc3.value or cellb3.value == celld3.value or cellb3.value == celle3.value or cellb3.value == cellf3.value or cellb3.value == cellg3.value:
                new_valueb15 = st.selectbox('نوع روکش وزنه تعادل',
                                            options=[cellc15.value, celld15.value],
                                            key=f'{cellb15.coordinate}_{sheet_name}')
                if new_valueb15 == cellc15.value:
                    cellb15.value = cellc15.value
                elif new_valueb15 == celld15.value:
                    cellb15.value = celld15.value
            elif cellb3.value == cellh3.value or cellb3.value == celli3.value or cellb3.value == cellj3.value or cellb3.value == cellk3.value or cellb3.value == celll3.value or cellb3.value == cellm3.value:
                new_valueb15 = st.selectbox('نوع روکش وزنه تعادل', options=[celld15.value],
                                            key=f'{cellb15.coordinate}_{sheet_name}')
                if new_valueb15 == celld15.value:
                    cellb15.value = celld15.value
with cols[2]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ws = wb[sheet_name]
            cellb22 = ws['B22']
            new_valueb22 = st.number_input('تعداد درب طبقات',
                                          key=f'{cellb22.coordinate}_{sheet_name}', value=1)
cols = st.columns(3)
with cols[0]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            celld23 = ws['D23']
            celle23 = ws['E23']
            new_valueb23 = st.selectbox('تعداد درب کابین', options=[cellc23.value, celld23.value, celle23.value],
                                       key=f'{cellb23.coordinate}_{sheet_name}')
            if new_valueb23 == cellc23.value:
                cellb23.value = cellc23.value
            elif new_valueb23 == celld23.value:
                cellb23.value = celld23.value
            elif new_valueb23 == celle23.value:
                cellb23.value = celle23.value
with cols[1]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            cellf24 = ws['F24']
            cellg24 = ws['G24']
            new_valueb24 = st.selectbox('ارتفاع درب (متر)', options=[cellc24.value, celld24.value, celle24.value,
                                                                      cellf24.value, cellg24.value],
                                       key=f'{cellb24.coordinate}_{sheet_name}')
            if new_valueb24 == cellc24.value:
                cellb24.value = cellc24.value
            elif new_valueb24 == celld24.value:
                cellb24.value = celld24.value
            elif new_valueb24 == celle24.value:
                cellb24.value = celle24.value
            elif new_valueb24 == cellf24.value:
                cellb24.value = cellf24.value
            elif new_valueb24 == cellg24.value:
                cellb24.value = cellg24.value
with cols[2]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            celld25 = ws['D25']
            celle25 = ws['E25']
            new_valueb25 = st.selectbox('برند موتور', options=[cellc25.value, celld25.value, celle25.value],
                                       key=f'{cellb25.coordinate}_{sheet_name}')
            if new_valueb25 == cellc25.value:
                cellb25.value = cellc25.value
            elif new_valueb25 == celld25.value:
                cellb25.value = celld25.value
            elif new_valueb25 == celle25.value:
                cellb25.value = celle25.value
cols = st.columns(3)
with cols[0]:            
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            cellf26 = ws['F26']
            cellg26 = ws['G26']
            new_valueb26 = st.selectbox('برند ریل', options=[cellc26.value, celld26.value, celle26.value, cellf26.value, cellg26.value],
                                       key=f'{cellb26.coordinate}_{sheet_name}')
            if new_valueb26 == cellc26.value:
                cellb26.value = cellc26.value
            elif new_valueb26 == celld26.value:
                cellb26.value = celld26.value
            elif new_valueb26 == celle26.value:
                cellb26.value = celle26.value
            elif new_valueb26 == cellf26.value:
                cellb26.value = cellf26.value
            elif new_valueb26 == cellg26.value:
                cellb26.value = cellg26.value
with cols[1]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            celld27 = ws['D27']
            celle27 = ws['E27']
            new_valueb27 = st.selectbox('برند سیم بکسل', options=[cellc27.value, celld27.value, celle27.value],
                                       key=f'{cellb27.coordinate}_{sheet_name}')
            if new_valueb27 == cellc27.value:
                cellb27.value = cellc27.value
            elif new_valueb27 == celld27.value:
                cellb27.value = celld27.value
            elif new_valueb27 == celle27.value:
                cellb27.value = celle27.value
with cols[2]:
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            cellc28 = ws['C28']
            celld28 = ws['D28']
            new_valueb28 = st.selectbox('نوع کاربری آسانسور', options=[cellc28.value, celld28.value],
                                       key=f'{cellb28.coordinate}_{sheet_name}')
            if new_valueb28 == cellc28.value:
                cellb28.value = cellc28.value
            elif new_valueb28 == celld28.value:
                cellb28.value = celld28.value    
cols = st.columns(3)
with cols[2]:            
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            if cellb19.value == celld19.value:
                new_valueb29 = st.selectbox('نوع براکت',
                                            options=[cellc29.value, celld29.value],
                                            key=f'{cellb29.coordinate}_{sheet_name}')
                if new_valueb29 == cellc29.value:
                    cellb29.value = cellc29.value
                elif new_valueb29 == celld29.value:
                    cellb29.value = celld29.value
            elif cellb19.value == cellc19.value:
                new_valueb29 = st.selectbox('نوع براکت', options=[cellc29.value],
                                            key=f'{cellb29.coordinate}_{sheet_name}')
                if new_valueb29 == cellc29.value:
                    cellb29.value = cellc29.value 
with cols[1]:            
    ...
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
            ...
            cellc30 = ws['C30']
            celld30 = ws['D30']
            new_valueb30 = st.selectbox('موقعیت قاب وزنه', options=[cellc30.value, celld30.value],
                                       key=f'{cellb30.coordinate}_{sheet_name}')
            if new_valueb30 == cellc30.value:
                cellb30.value = cellc30.value
            elif new_valueb30 == celld30.value:
                cellb30.value = celld30.value
with cols[0]: 
    sheet_names = wb.sheetnames
    for sheet_name in sheet_names:
        if sheet_name == 'Data (1)':
...
if cellb5.value == cellc5.value and cellb19.value == cellc19.value and (cellb3.value == cellc3.value or cellb3.value == celld3.value or cellb3.value == celle3.value):
    ...
    new_valueb17 = celld17.value
elif cellb5.value == cellc5.value and cellb19.value == cellc19.value and (cellb3.value == cellh3.value or cellb3.value == celli3.value or cellb3.value == cellj3.value or cellb3.value == cellk3.value or cellb3.value == celll3.value or cellb3.value == cellm3.value or cellb3.value == celln3.value):
    new_valueb17 = celle17.value
    ...
    new_valueb17 = celld17.value
elif cellb5.value == celld5.value and cellb19.value == cellc19.value and (cellb3.value == cellh3.value or cellb3.value == celli3.value or cellb3.value == cellj3.value or cellb3.value == cellk3.value or cellb3.value == celll3.value or cellb3.value == cellm3.value or cellb3.value == celln3.value):
    new_valueb17 = celle17.value
    ...
    new_valueb17 = celle17.value
elif cellb5.value == cellc5.value and cellb19.value == celld19.value and (cellb3.value == cellj3.value or cellb3.value == cellk3.value or cellb3.value == celll3.value or cellb3.value == cellm3.value or cellb3.value == celln3.value):
    new_valueb17 = cellf17.value
    ...
    new_valueb17 = cellf17.value
elif cellb19.value == celld19.value and (cellb3.value == cellm3.value or cellb3.value == celln3.value):
    new_valueb17 = cellg17.value             
...
if st.button('ثبت'):
    ...
    new_valuem3 = ws1['M3'].value
    new_valuen3 = ws1['N3'].value
    new_valueb5 = ws1['B5'].value
    new_valuec5 = ws1['C5'].value
    new_valued5 = ws1['D5'].value
    new_valuebbb8 = new_valueb4
    new_valuebb8 = (new_valueb6-1)
    new_valueb8 = new_valuebb8*new_valuebb8
    ...
    new_valuej6 = ws1['J6'].value
    new_valuek6 = ws1['K6'].value
    new_valuel6 = ws1['L6'].value
    new_valuem6 = ws1['M6'].value
    new_valuen6 = ws1['N6'].value
    new_valueo6 = ws1['O6'].value
    new_valuep6 = ws1['P6'].value
    new_valueq6 = ws1['Q6'].value
    new_valuer6 = ws1['R6'].value
    new_values6 = ws1['S6'].value
    new_valuet6 = ws1['T6'].value
    new_valueu6 = ws1['U6'].value
    new_valuev6 = ws1['V6'].value
    new_valuew6 = ws1['W6'].value
    new_valuex6 = ws1['X6'].value
    new_valuey6 = ws1['Y6'].value
    new_valuez6 = ws1['Z6'].value
    new_valueaa6 = ws1['AA6'].value
    new_valueab6 = ws1['AB6'].value
    new_valueac6 = ws1['AC6'].value
    new_valuead6 = ws1['AD6'].value
    new_valueae6 = ws1['AE6'].value
    new_valueb14 = ws1['B14'].value
    new_valuec14 = ws1['C14'].value
    new_valued14 = ws1['D14'].value
    new_valuee14 = ws1['E14'].value
    new_valuef14 = ws1['F14'].value
    new_valueg14 = ws1['G14'].value
    ...
    if ws1['B6'].value != ws1['C6'].value or ws1['B6'].value != ws1['D6'].value or ws1['B6'].value != ws1['E6'].value:
        if new_valueb6 == new_valuef6:    
    ...
    if new_valueb6 == new_valuec6 or new_valueb6 == new_valued6 or new_valueb6 == new_valuee6 or new_valueb6 == new_valuef6 or new_valueb6 == new_valueg6 or new_valueb6 == new_valueh6:
        ...
        SimafshanGreenDescription = f"""
                    ...
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AF6'].value:,.0f}</td></tr></table>
                                                                """
        st.markdown(SimafshanGreenDescription, unsafe_allow_html=True)
    if new_valueb6 == new_valuec6 or new_valueb6 == new_valued6 or new_valueb6 == new_valuee6 or new_valueb6 == new_valuef6 or new_valueb6 == new_valueg6 or new_valueb6 == new_valueh6 or new_valueb6 == new_valuei6:
        ...
        SimafshanRedDescription = f"""
                    ...
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AF7'].value:,.0f}</td></tr></table>
                                                                """
        st.markdown(SimafshanRedDescription, unsafe_allow_html=True)
    if new_valueb6 == new_valuec6 or new_valueb6 == new_valued6 or new_valueb6 == new_valuee6 or new_valueb6 == new_valuef6 or new_valueb6 == new_valueg6 or new_valueb6 == new_valueh6 or new_valueb6 == new_valuei6 or new_valueb6 == new_valuej6:
    ...
    if new_valueb14 == new_valuec14 and new_valueb3 == new_valuec3:
        ...
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuem3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS10'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuem3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS3'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuec14 and new_valueb3 == new_valuen3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS10'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuen3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS3'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valued14 and new_valueb3 == new_valuec3:
        ...
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valued14 and new_valueb3 == new_valuem3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS5'].value}<br>{ws2['AS12'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuem3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS5'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valued14 and new_valueb3 == new_valuen3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS5'].value}<br>{ws2['AS12'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuen3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS5'].value:,.0f}</td></tr></table>
        ...
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuee14 and new_valueb3 == new_valuem3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS7'].value}<br>{ws2['AS14'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuem3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS7'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuee14 and new_valueb3 == new_valuen3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS7'].value}<br>{ws2['AS14'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuen3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS7'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuef14 and new_valueb3 == new_valueh3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS16'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valueh3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS16'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuef14 and new_valueb3 == new_valuei3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS16'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuei3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS16'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuef14 and new_valueb3 == new_valuej3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS16'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuej3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS16'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuef14 and new_valueb3 == new_valuek3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS16'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuek3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS16'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuef14 and new_valueb3 == new_valuel3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS16'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuel3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS16'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuef14 and new_valueb3 == new_valuem3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS16'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuem3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS16'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valuef14 and new_valueb3 == new_valuen3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS16'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuen3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS16'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valueg14 and new_valueb3 == new_valueh3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS18'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valueh3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS18'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valueg14 and new_valueb3 == new_valuei3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS18'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuei3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS18'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valueg14 and new_valueb3 == new_valuej3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS18'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuej3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS18'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valueg14 and new_valueb3 == new_valuek3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS18'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuek3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS18'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valueg14 and new_valueb3 == new_valuel3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS18'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuel3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS18'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valueg14 and new_valueb3 == new_valuem3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS18'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuem3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS18'].value:,.0f}</td></tr></table>
        """
        st.markdown(WazneTadolDescription, unsafe_allow_html=True)
    elif new_valueb14 == new_valueg14 and new_valueb3 == new_valuen3:
        WazneTadolDescription = f"""
        <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AS3'].value}<br>{ws2['AS18'].value}</td>
        <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * int((new_valueb16 + (0.5 * 75 * new_valuen3) - 75))}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AS18'].value:,.0f}</td></tr></table>
    ...
    elif new_valueb3 == new_valueh3 or new_valueb3 == new_valuei3:
        BatteryDescription = f"""
                                <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AV2'].value}</td>
                                <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * 3}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AV2'].value:,.0f}</td></tr></table>
                                """
        st.markdown(BatteryDescription, unsafe_allow_html=True)
    elif new_valueb3 == new_valuej3 or new_valueb3 == new_valuek3 or new_valueb3 == new_valuel3:
        BatteryDescription = f"""
                                <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AV2'].value}</td>
                                <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * 4}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AV2'].value:,.0f}</td></tr></table>
                                """
        st.markdown(BatteryDescription, unsafe_allow_html=True)
    elif new_valueb3 == new_valuem3 or new_valueb3 == new_valuen3:
        BatteryDescription = f"""
                                <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AV2'].value}</td>
                                <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * 5}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['AV2'].value:,.0f}</td></tr></table>
    ...
    if new_valueb18 == new_valued18:
        ParkPlateDescription = f"""
                                <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['BA2'].value}</td>
                                <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * 1}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['BC2'].value:,.0f}</td></tr></table>
                                """
        st.markdown(ParkPlateDescription, unsafe_allow_html=True)
    
    if new_valueb19 == new_valued19 and new_valueb20 == new_valued20:
        MechanicalPackageDescription = f"""
                                <table style="width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;height:60px;direction:rtl;background-color:#f0f0f0;border-radius:5px;"><tr><td style="width:80%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-right-radius:5px;border-bottom-right-radius:5px;">{ws2['AZ2'].value}</td>
                                <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;;font-size:1rem;">{int(new_valueb2) * 1}</td>
                    <td style="width:10%;border:1px solid #ddd;padding:10px;white-space:nowrap;text-align:center;vertical-align:middle;border-top-left-radius:5px;border-bottom-left-radius:5px;;font-size:1rem;">{ws3['BB2'].value:,.0f}</td></tr></table>
                                """
        st.markdown(MechanicalPackageDescription, unsafe_allow_html=True)
    ...
    row_source_names = {
        ...
        115: 'ParkPlateDescription',
        116: 'MechanicalPackageDescription'
    }    
